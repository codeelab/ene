...
<div class="row wrapper border-bottom white-bg page-heading">
            ...
            <?php include("controller/profile_talleres.php");?>
        </div>

                        <!--  INICIO DEL POP UP TALLERES -->
                            <div class="modal inmodal" id="taller" tabindex="-1" role="dialog" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content animated flipInY">
                                        ...
                                        <div class="modal-body">
                                            <?php include('controller/form_update_taller.php'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
