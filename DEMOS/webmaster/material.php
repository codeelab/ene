...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Folios Material Entregado</h2>
                    <ol class="breadcrumb">
                        <li>
                                    ...
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-warning">
                                                <?php
                                                $result = mysql_query($alumnas_entregado);
                                    ...
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-success">
                                                <?php
                                                $result = mysql_query($estudiante_entregado);
                                                $status = mysql_num_rows($result);
                                                echo '<span class="font-bold">'.$status.'</span>';
                                                //echo $numero;
                                                ?>
                                    ...
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-danger">
                                                <?php
                                                $result = mysql_query($tutora_entregado);
                                                $status = mysql_num_rows($result);
                                                echo '<span class="font-bold">'.$status.'</span>';
                                                //echo $numero;
                                                ?>
                                    ...
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-info">
                                                <?php
                                                $result = mysql_query($asistente_entregado);
                                                $status = mysql_num_rows($result);
                                                echo '<span class="font-bold">'.$status.'</span>';
                                                //echo $numero;
                                                ?>
