...
$solicitud = $_POST['id_publico'];
$nombre = $_POST['nombre'];
$a_paterno = $_POST['a_paterno'];
$a_materno = $_POST['a_materno'];
$c_personal = $_POST['c_personal'];
...
$costo = $_POST['costo'];
        ...
        mysql_query("UPDATE publico SET correo_reg  = 1 WHERE id_publico='".$solicitud."'");
...
//$mail->AddBCC("softcodec@gmail.com");
$mail->Timeout=120;
$mail->IsHTML(true);
$mail->CharSet = 'UTF-8';
...
<li>Enviar el comprobante de pago escaneado en formato PDF al correo: enemorelia@hotmail.com, anexando su Folio y Nombre completo. </li>
