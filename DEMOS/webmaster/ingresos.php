                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <span class="icons-awesome">
                                            ...
                                            <br>
                                        <span class="icons-awesome">
                                            <span class="pull-right"><i class="fa fa-percent fa-3x"></i></span>
                                        </span>
                                            <small>PORCENTAJE</small>
                                            <h1 class="no-margins text-warning">
                                                <?php
                                                $row = mysql_fetch_array($money_alumnas_por, MYSQL_ASSOC);
                                                $porcentaje = $row['promedio'];
                                                echo '<span class="font-bold">'.$porcentaje.'</span>';
                                                //echo $numero;
                                                ?>
                                            </h1>
                                    </div>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-success">
                                                <?php
                                                $row = mysql_fetch_array($money_estudiantes_por, MYSQL_ASSOC);
                                                $porcentaje = $row['promedio'];
                                                echo '<span class="font-bold">'.$porcentaje.'</span>';
                                                //echo $numero;
                                                ?>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-danger">
                                                <?php
                                                $row = mysql_fetch_array($money_tutoras_por, MYSQL_ASSOC);
                                                $porcentaje = $row['promedio'];
                                                echo '<span class="font-bold">'.$porcentaje.'</span>';
                                                //echo $numero;
                                                ?>
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <span class="icons-awesome">
                                            ...
                                            <h1 class="no-margins text-info">
                                                <?php
                                                $row = mysql_fetch_array($money_asistentes_por, MYSQL_ASSOC);
                                                $porcentaje = $row['promedio'];
                                                echo '<span class="font-bold">'.$porcentaje.'</span>';
                                                //echo $numero;
                                                ?>
        ...
        <div class="row">
                <div class="col-lg-12">
                            <div class="col-lg-3">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <span class="label label-info pull-right">INGRESOS</span>
                                            <h5>INSCRIPCIONES</h5>
                                    </div>
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
