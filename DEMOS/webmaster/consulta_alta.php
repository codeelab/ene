...
$retorno->registro=array(
	...
	'id_publico_alumno'=>$row_cliente['id_publico'],
	'nombre_alumno'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
	'para_alumno'=>$row_cliente['c_personal']
);
