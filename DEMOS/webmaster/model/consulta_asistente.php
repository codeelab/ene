...
$retorno->registro=array(
    ...
    'id_publico_asistente'=>$row_cliente['id_publico'],
    'nombre_asistente'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_asistente'=>$row_cliente['a_paterno'],
    'materno_asistente'=>$row_cliente['a_materno'],
    'para_asistente'=>$row_cliente['c_personal']
);
