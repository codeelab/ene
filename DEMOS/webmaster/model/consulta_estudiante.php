...
$retorno->registro=array(
    ...
    'id_publico_estudiante'=>$row_cliente['id_publico'],
    'nombre_estudiante'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_estudiante'=>$row_cliente['a_paterno'],
    'materno_estudiante'=>$row_cliente['a_materno'],
    'para_estudiante'=>$row_cliente['c_personal']
);
