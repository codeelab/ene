...
$retorno->registro=array(
    ...
    'id_publico_estudiante_a'=>$row_cliente['id_publico'],
    'nombre_estudiante_a'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_estudiante_a'=>$row_cliente['a_paterno'],
    'materno_estudiante_a'=>$row_cliente['a_materno'],
    'para_estudiante_a'=>$row_cliente['c_personal']
);
