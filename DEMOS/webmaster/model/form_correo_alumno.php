    <div class="row">
        <form action="model/correo.php?op=1" method="post" role="form">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="id_publico_alumno" id="id_publico_alumno" value="<?=$row['id_publico']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="nombre_alumno" id="nombre_alumno" value="<?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control col-sm-8 col-md-8" type="email" name="para_alumno" id="para_alumno" value="<?=$row['c_personal']?>" readonly>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea id="mensaje_alumno" name="mensaje_alumno" style="width: 100%;">
                  <p>Estimado (a): <?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?><br>
                  Correo electrónico: <?=$row['c_personal']?><br>
                  Tipo de inscripción:Alumna ENE<br>
                  Monto pagado: $350</p>
