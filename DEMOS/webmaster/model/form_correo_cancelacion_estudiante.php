    <div class="row">
        <form action="model/correo_cancelacion.php?op=2" method="post" role="form">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="id_publico_estudiante_c" id="id_publico_alumno_a" value="<?=$row['id_publico']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="nombre_estudiante_c" id="nombre_estudiante_c" value="<?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control col-sm-8 col-md-8" type="email" name="para_estudiante_c" id="para_estudiante_c" value="<?=$row['c_personal']?>" readonly>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea id="mensaje_estudiante_c" name="mensaje_estudiante_c" style="width: 100%;">
