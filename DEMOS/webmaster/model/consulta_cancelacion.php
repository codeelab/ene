...
$retorno->registro=array(
    ...
    'id_publico_alumno_c'=>$row_cliente['id_publico'],
    'nombre_alumno_c'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_alumno_c'=>$row_cliente['a_paterno'],
    'materno_alumno_c'=>$row_cliente['a_materno'],
    'para_alumno_c'=>$row_cliente['c_personal']
);
