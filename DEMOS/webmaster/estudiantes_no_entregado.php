...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Listado de Folios Material No Entregado a Estudiantes otras Escuelas </h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <a href="no_entregado">Material No Entregado</a>
                        </li>
                        <li class="active">
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php include("controller/profile_estudiantes_no_entregado.php");?>
