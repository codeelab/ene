            ...
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <span class="glyphicon glyphicon-bookmark"></span> REGISTRO ALUMNOS DE NIVEL LICENCIATURA DE CUALQUIER INSTITUCIÓN EDUCATIVA</h3>
                </div>
                <div class="panel-body">
                    <div class="row">
                <form role="form" id="institucion" class="form-horizontal" method="post" accept-charset="utf-8">
                    ...
                    <label class="col-sm-2 control-label">Escuela</label>
                        <div class="col-sm-10"><input type="text" name="procedencia" id="procedencia" placeholder="Institución Educativa de Procedencia" class="form-control" autocomplete="off"></div>
                    </div>
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn btn-block btn-rounded ladda-button ladda-button-check btn btn-success" type="submit" id="BtnInstitucion">Enviar</button>
                </form>
                <br>

<div class="alert alert-info">
  <strong>Nota:</strong> PARA RECOGER SU MATERIAL ES INDISPENSABLE PRESENTAR SU CREDENCIAL VIGENTE DE ESTUDIANTE DE LICENCIATURA CON FOTOGRAFÍA, DE LO CONTRARIO DEBERA CUBRIR LA DIFERENCIA DEL COSTO DEL EVENTO.</a>
</div>
    ...
    <script type="text/javascript">
         $('#institucion').bootstrapValidator({
        ...
        fields: {
            ...
            procedencia: {
                validators: {
                    notEmpty: {
                        message: 'Es necesario agregar la institución educativa.'
                    },
                    regexp: {
                        regexp: /^[ A-Za-zäÄëËïÏöÖüÜáéíóúáéíóúÁÉÍÓÚÂÊÎÔÛâêîôûàèìòùÀÈÌÒÙ.-]+$/,
                        message: 'Sólo esta permitido el uso de Letras!'
...
var datos='id_taller='+id+ '&nombre='+nombre+ '&a_paterno='+a_paterno+ '&a_materno='+a_materno+ '&procedencia='+procedencia+ '&medio='+medio+ '&c_personal='+c_personal+ '&acepto='+acepto;

    $.ajax({
        url:'lib/reg_licenciatura.php', // url del archivo php
