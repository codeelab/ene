...
<html lang=&quot;es&quot;>
    ...
    <body>
        <div class=&quot;container&quot;>
            <h2>Oops! Error <span>403</span></h2>
            <p style="font-size: 18px;">¡Vaya! Usted no tiene acceso a esta página.<br /></p>
            <a href="javascript:history.back(1)"><button class="button">Regresar</button></a>
        </div>
    </body>
</html>