    <div class="row">
        <form action="model/correo.php?op=4" method="post" role="form">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="id_publico_asistente" id="id_publico_asistente" value="<?=$row['id_publico']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="nombre_asistente" id="nombre_asistente" value="<?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control col-sm-8 col-md-8" type="email" name="para_asistente" id="para_asistente" value="<?=$row['c_personal']?>" readonly>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea id="mensaje_asistente" name="mensaje_asistente" style="width: 100%;">
                  <p>Estimado (a): <?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?><br>
                  Correo electrónico: <?=$row['c_personal']?><br>
                  Tipo de inscripción: Participante<br>
                  Monto pagado: $1200</p>
