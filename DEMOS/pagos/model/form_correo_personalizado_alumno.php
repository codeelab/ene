    <div class="row">
        <form action="model/correo_personalizado.php?op=1" method="post" role="form">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="id_publico_alumno_p" id="id_publico_alumno_p" value="<?=$row['id_publico']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="nombre_alumno_p" id="nombre_alumno_p" value="<?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control col-sm-8 col-md-8" type="email" name="para_alumno_p" id="para_alumno_p" value="<?=$row['c_personal']?>" readonly>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea id="mensaje_alumno_p" name="mensaje_alumno_p" style="width: 100%;" rows="10">
