...
$id = $_GET['id'];
$ficha = "SELECT * FROM publico WHERE id_publico='".$id."'";
$res = mysql_query($ficha, $link) or die(mysql_error());
...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>ACTUALIZACIÓN FICHA DE PAGO ALUMNA ENE </h2>
                    <ol class="breadcrumb">
                        <li>
                            <a href="index">INICIO</a>
                        </li>
                        <li>
                            <a href="deposito">FOLIO</a>
                        </li>
                        <li class="active">
                            <strong>FICHA</strong>
                        </li>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php include("model/update_ficha.php");?>
