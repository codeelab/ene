...
$sql="INSERT INTO publico(nombre, a_paterno, a_materno, matricula, soy, procedencia, taller, medio, tipo, costo, material, entrego, aviso, status) values ('".$nombre."','".$a_paterno."','".$a_materno."','".$matricula."','Estudiante','".$procedencia."','".$taller."','".$medio."',2,'".$costo."','".$material."','".$entrego."','".$aviso."',".$status.")";
