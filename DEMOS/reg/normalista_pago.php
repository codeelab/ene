...
<body>
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Listado de Folios Pagados Normalistas Foráneos </h2>
                    <ol class="breadcrumb">
                        <li>
                        ...
                        <li>
                            <a href="pagado">Pagados</a>
                        </li>
                        <li class="active">
                            <strong>Normalistas Foráneos</strong>
                        </li>
                    </ol>
                </div>
            </div>
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <?php include("controller/profile_normalistas_pagado.php");?>
