...
if($reg['tipo']==1){
  $tipo="Alumna ENE";
    ...
    if ($reg['status']==0){
      echo '<td>
        <div>
            <a href="lib/pdf_alumno.php?id='.$id.'"><button type="button" class="btn btn-danger btn-circle" value="alumnoEne" title="Confirmación de Registro"><span class="fa fa-file-pdf-o" ></span></button></a>
  ...
  $tipo="Estudiante";
    ...
    if ($reg['status']==0){
      echo '<td>
        <div>
            <a href="lib/pdf_estudiante.php?id='.$id.'"><button type="button" class="btn btn-danger btn-circle" value="alumnoEne" title="Confirmación de Registro"><span class="fa fa-file-pdf-o" ></span></button></a>
            <a onclick="cancelaFolio('.$cod.')"><button type="button" class="btn btn-default btn-circle" title="Eliminar Registro"><span class="fa fa-remove"></span></button></a>
        </div></td>';
    }else if ($reg['status']==2 AND $reg['material']==0){
        echo '<td>
  ...
  $tipo="Tutora";
    ...
    if ($reg['status']==0){
      echo '<td>
        <div>
            <a href="lib/pdf_tutora.php?id='.$id.'"><button type="button" class="btn btn-danger btn-circle" value="alumnoEne" title="Confirmación de Registro"><span class="fa fa-file-pdf-o" ></span></button></a>
            <a onclick="cancelaFolio('.$cod.')"><button type="button" class="btn btn-default btn-circle" title="Eliminar Registro"><span class="fa fa-remove"></span></button></a>
        </div></td>';
    }else if ($reg['status']==2 AND $reg['material']==0){
        echo '<td>
   ...
   $tipo="Participante";
    ...
    if ($reg['status']==0){
      echo '<td>
        <div>
            <a href="lib/pdf_asistente.php?id='.$id.'"><button type="button" class="btn btn-danger btn-circle" value="alumnoEne" title="Confirmación de Registro"><span class="fa fa-file-pdf-o" ></span></button></a>
            <a onclick="cancelaFolio('.$cod.')"><button type="button" class="btn btn-default btn-circle" title="Eliminar Registro"><span class="fa fa-remove"></span></button></a>
        </div></td>';
    }else if ($reg['status']==2 AND $reg['material']==0){
        echo '<td>
