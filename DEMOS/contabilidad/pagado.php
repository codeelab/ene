                ...
                <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="ibox float-e-margins">
                                    <div class="ibox-title">
                                        <span class="label label-normalista pull-right">Folio</span>
                                            <h5>Normales Foráneas</h5>
                                    </div>
                                    <div class="ibox-content">
                                        <span class="icons-awesome">
                                            <span class="pull-right"><i class="fa fa-ticket fa-5x"></i></span>
                                            ...
                                            <small>Registros</small>
                                            <h1 class="no-margins text-normalista">
                                                <?php
                                                $result = mysql_query($normalistas_pago);
                                                $status = mysql_num_rows($result);
                                                echo '<span class="font-bold">'.$status.'</span>';
                                                //echo $numero;
                                                ?>
                                    ...
                                    <a href="normalista_pago">
                                    <button class="btn btn-block btn-outline ladda-button ladda-button-check btn btn-normalista" data-style="expand-right"><i class="fa fa-eye" aria-hidden="true"></i>   Ver</button>
                                    </a>
                                </div>
                            </div>
