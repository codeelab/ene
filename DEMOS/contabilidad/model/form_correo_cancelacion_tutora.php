    <div class="row">
        <form action="model/correo_cancelacion.php?op=3" method="post" role="form">
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="id_publico_tutora_c" id="id_publico_tutora_c" value="<?=$row['id_publico']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control" type="text" name="nombre_tutora_c" id="nombre_tutora_c" value="<?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?>" readonly>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input class="form-control col-sm-8 col-md-8" type="email" name="para_tutora_c" id="para_tutora_c" value="<?=$row['c_personal']?>" readonly>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <textarea id="mensaje_tutora_c" name="mensaje_tutora_c" style="width: 100%;">
                  <p>Estimado (a): <?=$row['nombre'].' '.$row['a_paterno'].' '.$row['a_materno']?><br>
                  Correo electrónico: <?=$row['c_personal']?><br>
                  Tipo de inscripción: Tutora</p>
