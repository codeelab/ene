...
$sql="INSERT INTO publico(nombre, a_paterno, a_materno, matricula, soy, procedencia, taller, medio, acepto, c_personal, tipo, costo, material, aviso, status) values ('".$nombre."','".$a_paterno."','".$a_materno."','".$matricula."','Tutora','".$procedencia."','".$taller."','".$medio."','".$acepto."','".$c_personal."',3,'".$costo."','".$material."','".$aviso."',".$status.")";
