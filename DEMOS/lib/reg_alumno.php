...
if(isset($_POST["procedencia"])){$procedencia = strip_tags($_POST["procedencia"]); }else $procedencia="NORMAL DE EDUCADORAS";
...
$sql="INSERT INTO publico(nombre, a_paterno, a_materno, matricula, soy, procedencia, taller, medio, acepto, c_personal, tipo, costo, material, entrego, aviso, status) values ('".$nombre."','".$a_paterno."','".$a_materno."','".$matricula."','Alumno','".$procedencia."','".$taller."','".$medio."','".$acepto."','".$c_personal."',1,'".$costo."','".$material."','".$entrego."','".$aviso."',".$status.")";
