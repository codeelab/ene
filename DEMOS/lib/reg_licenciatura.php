...
$sql="INSERT INTO publico(nombre, a_paterno, a_materno, matricula, soy, procedencia, taller, medio, acepto, c_personal, tipo, costo, material, entrego, aviso, status) values ('".$nombre."','".$a_paterno."','".$a_materno."','".$matricula."','Estudiante','".$procedencia."','".$taller."','".$medio."','".$acepto."','".$c_personal."',2,'".$costo."','".$material."','".$entrego."','".$aviso."',".$status.")";
...
$solicitud = mysql_insert_id();
       ...
       $pdf->Cell(0,5,utf8_decode("Escuela: ".$procedencia),0,1,'L');
       $pdf->Cell(0,5,utf8_decode("Correo: ".$c_personal),0,1,'L');
       $pdf->Cell(0,5,utf8_decode("Tipo de inscripción: Estudiante"),0,1,'L');
       $pdf->ln(5);
