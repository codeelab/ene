...
$retorno->registro=array(
    ...
    'id_publico_alumno_a'=>$row_cliente['id_publico'],
    'nombre_alumno_a'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_alumno_a'=>$row_cliente['a_paterno'],
    'materno_alumno_a'=>$row_cliente['a_materno'],
    'para_alumno_a'=>$row_cliente['c_personal']
);
