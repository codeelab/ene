...
$retorno->registro=array(
    ...
    'id_publico_tutora_a'=>$row_cliente['id_publico'],
    'nombre_tutora_a'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_tutora_a'=>$row_cliente['a_paterno'],
    'materno_tutora_a'=>$row_cliente['a_materno'],
    'para_tutora_a'=>$row_cliente['c_personal']
);
