...
$retorno->registro=array(
    ...
    'id_publico_asistente_a'=>$row_cliente['id_publico'],
    'nombre_asistente_a'=>$row_cliente['nombre'].' '.$row_cliente['a_paterno'].' '.$row_cliente['a_materno'],
    'paterno_asistente_a'=>$row_cliente['a_paterno'],
    'materno_asistente_a'=>$row_cliente['a_materno'],
    'para_asistente_a'=>$row_cliente['c_personal']
);
