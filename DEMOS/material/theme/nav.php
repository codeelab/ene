        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                   ...
                   <li>
                    <a href="folio"><i class="fa fa-ticket fa-w"></i> <span class="nav-label">M. Pendiente </span><span class="label label-danger pull-right"><? echo $hay; ?></span></a>
                   </li>
                   <li>
                    <a href="folios_entregados"><i class="fa fa-ticket fa-w"></i> <span class="nav-label">M. Entregado </span><span class="label label-info pull-right"><? echo $hay2; ?></span></a>
                   </li>
                <li>
