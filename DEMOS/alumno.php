  ...
  <strong>Aviso!</strong> Estimado usuario(a), una vez registrado en el Foro Nacional de Educación Preescolar se le enviará un correo electrónico de registro con los datos de pago, los tiempos estimados de llegada son de <b>1 a 30 minutos</b>, en caso de no recibir respuesta, favor de comunicarse al siguiente correo: <b>foroenemorelia@gmail.com</b></a>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                <form role="form" id="alumno" class="form-horizontal"  method="post" accept-charset="utf-8">
                    ...
                    <button class="btn btn-block btn-rounded ladda-button ladda-button-check btn btn-primary" type="submit" id="BtnAlumno">Enviar</button>
                </form>
...
var datos='id_taller='+id+ '&nombre='+nombre+ '&a_paterno='+a_paterno+ '&a_materno='+a_materno+ '&matricula='+matricula+ '&medio='+medio+ '&c_personal='+c_personal+ '&acepto='+acepto;

    $.ajax({
        url:'lib/reg_alumno.php', // url del archivo php
