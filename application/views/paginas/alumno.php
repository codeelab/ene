            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                   <label class="control-label"><p class="text-uppercase text-form">Apellido Paterno:</p></label>
                    <input type="text" name="a_paterno" id="a_paterno" placeholder="Apellido Paterno" class="form-control" autocomplete="off" value="<?php echo set_value('a_paterno'); ?>" readonly>
                ...
                <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                    ...
                    <input type="text" name="a_materno" id="a_materno" placeholder="Apellido Materno" class="form-control" autocomplete="off" value="<?php echo set_value('a_materno'); ?>" readonly>
